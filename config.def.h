...
static const char dmenufont[]       = "Hack:size=10:antialias=true:autohint=true";static const char col_gray1[]       = "#222222";
...
/* tagging */
static const char *tags[] = { "WWW","File-Edit","Games","Chat","OBS","Photo","Camera","Misc","Other" };
